...
Context provider. Accepts **every** [`useNumberFieldState`](/docs/api/use-number-field-state)
and [`useNumberField`](/docs/api/use-number-field) option (`step`, `formatOptions`,
...
See [Formatting & Behavior → Change reasons](/docs/guides/formatting#change-reasons)
